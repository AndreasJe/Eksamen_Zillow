    ...
    <form class="" onsubmit="return false" runat="server">
        ...
        <section>
            ...
            <div class=" rounded d-flex justify-content-center preview-container w-50">
                <img id="preview" src="../img/user/img_<?php echo $_SESSION['user_id'] ?>" alt="your image" />
            </div>
        </section>
        <div class="seperator"></div>
        ...
        <button id="uploadButton" type="button" class="btn btn-primary disabled" onclick="uploadButton()">Post for sale
            by
            owner</button>
    </form>
