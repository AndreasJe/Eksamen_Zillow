<!-- FOOTER Stolen from ZILLOW.COM -->

<div class="footer_cunt" data-testid="footer">
    ...
    <style
        static-data-ssr-styled-pfs="bGHbct diOWNM bwYmdy gmUUKe XoXQt jwIUwf ddCQjT bwvdnR eRZAlu cSwgTd hFJOqm jAsqvA iPhRTS cInOeH cIQzMO bMPPMx eCEnCc fXxFYE aIAqv eeFcCq erdJTy kxwUUz kaSVVj gadpZM hObLRM kPNUVd"
        static-data-ssr-styled-version="4.4.1">
    /* sc-component-id: Icon-c11n-8-53-1__sc-13llmml-0 */
    .gadpZM {
    ...
    /* sc-component-id: Text-c11n-8-53-1__sc-aiai24-0 */
    .cSwgTd {
        color: #54545a;
    ...
    .cSwgTd>.Icon-c11n-8-53-1__sc-13llmml-0 {
        margin-top: 3px;
    }
    ...
    /* sc-component-id: Anchor-c11n-8-53-1__sc-hn4bge-0 */
    .hFJOqm {
        cursor: pointer;
        font-size: inherit;
        font-weight: inherit;
    ...
    /* sc-component-id: StyledTextButton-c11n-8-53-1__sc-n1gfmh-0 */
    .XoXQt {
        color: #2a2a33;
        -webkit-font-smoothing: antialiased;
        -moz-osx-font-smoothing: grayscale;
    ...
    .XoXQt>.Icon-c11n-8-53-1__sc-13llmml-0 {
        margin-top: 5px;
    }
    ...
    .jwIUwf>.Icon-c11n-8-53-1__sc-13llmml-0 {
        margin-top: 5px;
    }
    ...
    /* sc-component-id: VisuallyHidden-c11n-8-53-1__sc-t8tewe-0 */
    .hObLRM {
        border: 0;
    ...
    /* sc-component-id: Spacer-c11n-8-53-1__sc-17suqs2-0 */
    .jAsqvA {
        margin: 8px;
    }

    /* sc-component-id: pfs__j60ma-0 */
    .bMPPMx {
        cursor: pointer;
        font-size: inherit;
        font-weight: inherit;
    ...
    /* sc-component-id: pfs__j60ma-1 */
    .eCEnCc {
        display: block;
        margin: auto;
    }

    /* sc-component-id: pfs__chkjii-0 */
    .iPhRTS {
        cursor: pointer;
        font-size: inherit;
        font-weight: inherit;
    ...
    /* sc-component-id: pfs__sc-16y5ofh-0 */
    .ddCQjT {
        margin-top: 16px;
        text-align: center;
    }
    ...
    /* sc-component-id: pfs__sc-16g5ked-0 */
    .bGHbct {
        background: white;
        max-width: 1280px;
        margin: auto;
    ...
    /* sc-component-id: sc-global-5758743 */
    #mobile-hdp .pfs__sc-16g5ked-0 {
        padding-bottom: 0;
    }

    /* sc-component-id: pfs__sc-5sfc2u-0 */
    .cInOeH {
        list-style: none;
    ...
    .bwvdnR li:last-child {
        margin-left: 8px;
    }

    .bwvdnR li:first-child {
        display: block;
    }
    ...
    /* sc-component-id: pfs__sc-1sj5qgb-0 */
    .eRZAlu {
        max-width: 720px;
        margin: auto;
        margin-bottom: 24px;
    ...
    /* sc-component-id: pfs__sc-1a1yrk2-0 */
    .cIQzMO {
        list-style: none;
        margin-inline-start: 0;
        margin-inline-end: 0;
    ...
    /* sc-component-id: pfs__sc-1kahb5i-0 */
    .gmUUKe {
        list-style: none;
        margin-inline-start: 0;
        margin-inline-end: 0;
    ...
    /* sc-component-id: sc-global-3774151466 */
    .brand-links {
        padding-left: 0;
    }
    ...
    /* sc-component-id: pfs__sc-1i1gn38-0 */
    .bwYmdy {
        margin: auto;
        padding: 24px 0;
        height: auto;
    ...
    /* sc-component-id: pfs__sc-1l86zl0-0 */
    .fXxFYE>span {
        margin: 0;
    }
    ...
    <div>
        <footer class="pfs__sc-16g5ked-0 bGHbct site-footer">
            <div class="pfs__cacbnh-0 diOWNM">
                <nav class="pfs__sc-1i1gn38-0 bwYmdy">
                    <ul data-za-category="Navigation" data-za-action="Footer" class="pfs__sc-1kahb5i-0 gmUUKe">
                        <li>
                            <a href="/z/corp/about/" class="StyledTextButton-c11n-8-53-1__sc-n1gfmh-0 XoXQt"
                                tabindex="0" data-za-category="!inherit" data-za-action="!inherit"
                                data-za-label="About">About</a>
                        </li>
                        <li>
                            <a href="/z/zestimate/" class="StyledTextButton-c11n-8-53-1__sc-n1gfmh-0 XoXQt" tabindex="0"
                                data-za-category="!inherit" data-za-action="!inherit"
                                data-za-label="Zestimates">Zestimates</a>
                        </li>
                        <li>
                            <a href="/research/" class="StyledTextButton-c11n-8-53-1__sc-n1gfmh-0 XoXQt" tabindex="0"
                                data-za-category="!inherit" data-za-action="!inherit"
                                data-za-label="Research">Research</a>
                        </li>
                        <li>
                            <a href="/careers/" class="StyledTextButton-c11n-8-53-1__sc-n1gfmh-0 XoXQt" tabindex="0"
                                data-za-category="!inherit" data-za-action="!inherit"
                                data-za-label="Careers">Careers</a>
                        </li>
                        <li>
                            <a href="https://zillow.zendesk.com/hc/en-us"
                                class="StyledTextButton-c11n-8-53-1__sc-n1gfmh-0 XoXQt" tabindex="0"
                                data-za-category="!inherit" data-za-action="!inherit" data-za-label="Help">Help</a>
                        </li>
                        <li>
                            <a href="/z/partners/advertise/" class="StyledTextButton-c11n-8-53-1__sc-n1gfmh-0 XoXQt"
                                tabindex="0" data-za-category="!inherit" data-za-action="!inherit"
                                data-za-label="Advertise">Advertise</a>
                        </li>
                        <li>
                            <a href="https://www.zillow.com/rental-manager/resources/fair-housing-guide/"
                                class="StyledTextButton-c11n-8-53-1__sc-n1gfmh-0 XoXQt" tabindex="0"
                                data-za-category="!inherit" data-za-action="!inherit"
                                data-za-label="Fair Housing Guide">Fair Housing Guide</a>
                        </li>
                        <li>
                            <a href="/z/corp/terms/" class="StyledTextButton-c11n-8-53-1__sc-n1gfmh-0 XoXQt"
                                tabindex="0" data-za-category="!inherit" data-za-action="!inherit"
                                data-za-label="Terms of use">Terms of use</a>
                        </li>
                        <li>
                            <a href="https://privacy.zillowgroup.com"
                                class="StyledTextButton-c11n-8-53-1__sc-n1gfmh-0 XoXQt" tabindex="0"
                                data-za-category="!inherit" data-za-action="!inherit"
                                data-za-label="Privacy Portal">Privacy Portal</a>
                        </li>
                        <li>
                            <a href="javascript:;" class="
                      StyledTextButton-c11n-8-53-1__sc-n1gfmh-0
                      XoXQt
                      cookie-preference
                    " tabindex="0" data-za-category="!inherit" data-za-action="!inherit"
                                data-za-label="Cookie Preference">Cookie Preference</a>
                        </li>
                        <li>
                            <a href="/blog/" class="StyledTextButton-c11n-8-53-1__sc-n1gfmh-0 XoXQt" tabindex="0"
                                data-za-category="!inherit" data-za-action="!inherit" data-za-label="Blog">Blog</a>
                        </li>
                        <li>
                            <a href="/tech/" class="StyledTextButton-c11n-8-53-1__sc-n1gfmh-0 XoXQt" tabindex="0"
                                data-za-category="!inherit" data-za-action="!inherit" data-za-label="AI">AI</a>
                        </li>
                        <li>
                            <a href="/z/buying/app-download/" class="StyledTextButton-c11n-8-53-1__sc-n1gfmh-0 XoXQt"
                                tabindex="0" data-za-category="!inherit" data-za-action="!inherit"
                                data-za-label="Mobile Apps">Mobile Apps</a>
                        </li>
                    </ul>
                    <div class="pfs__sc-16y5ofh-0 ddCQjT">
                        <a id="doNotSell" href="https://privacy.zillowgroup.com/cookie"
                            aria-label="Do not sell my personal information"
                            class="StyledTextButton-c11n-8-53-1__sc-n1gfmh-0 jwIUwf">Do Not Sell My Personal
                            Information<span aria-hidden="true">
                                →</span></a>
                    </div>
                </nav>
            </div>
            <div class="pfs__wsq7ni-0 bwvdnR">
                <div class="pfs__sc-1sj5qgb-0 eRZAlu">
                    <p class="Text-c11n-8-53-1__sc-aiai24-0 cSwgTd">
                        ...
                        <a href="https://zillow.zendesk.com/hc/en-us/requests/new?ticket_form_id=39140" rel="nofollow"
                            class="Anchor-c11n-8-53-1__sc-hn4bge-0 hFJOqm">let us know</a>.
                    </p>
                </div>
                <div class="pfs__sc-1sj5qgb-0 eRZAlu">
                    <p class="Text-c11n-8-53-1__sc-aiai24-0 cSwgTd">
                        ...
                        licenses in multiple provinces. A list of our real estate
                        licenses is available
                        <a href="/z/info/real-estate-licenses/"
                            class="Anchor-c11n-8-53-1__sc-hn4bge-0 hFJOqm">here</a>.<br />TREC:
                        <a href="https://s.zillow.net/pfs/static/TREC_ZINC_1-25-21.pdf" rel="nofollow"
                            class="Anchor-c11n-8-53-1__sc-hn4bge-0 hFJOqm">Information about brokerage services</a>,
                        <a href="https://www.trec.texas.gov/sites/default/files/pdf-forms/CN%201-3.pdf" rel="nofollow"
                            class="Anchor-c11n-8-53-1__sc-hn4bge-0 hFJOqm">Consumer protection
                            notice</a><br />California DRE #1522444
                    </p>
                    <div class="Spacer-c11n-8-53-1__sc-17suqs2-0 jAsqvA"></div>
                    <a href="https://www.zillow.com/z/info/contact-us/"
                        class="Anchor-c11n-8-53-1__sc-hn4bge-0 pfs__chkjii-0 iPhRTS">Contact Zillow, Inc.
                        Brokerage</a>
                    <p></p>
                </div>
                <div class="pfs__sc-1sj5qgb-0 eRZAlu">
                ...
                <ul class="pfs__sc-5sfc2u-0 cInOeH">
                    ...
                    <li>
                        <a
                            href="http://zillow.com/z/buying/app-download?itc=zw_zw_zw_zillow-footer_btn_android-download"><svg
                                width="108" height="32" viewBox="0 0 108 32" aria-labelledby="googlePlaySvg" role="img">
                                ...
                                <g fill="none" fill-rule="evenodd">
                                    <g fill-rule="nonzero">
                                        ...
                                        <path
                                            ...
                                            stroke="#FFF" stroke-width="0.2" fill="#2A2A33"></path>
                                        <path
                                    ...
                                    <path stroke="#FFF" stroke-width="0.5" stroke-linecap="square"
                                        d="M8.4 6l14.4 14.4M8.4 26L22 12.4"></path>
                                </g>
                            </svg></a>
                    </li>
                </ul>
                <ul class="pfs__sc-1a1yrk2-0 cIQzMO">
                    <li>
                        <a href="/" width="152" height="32" data-za-action="Zillow logo click"
                            data-za-category="!inherit" aria-label="Zillow.com homepage" version="DEFAULT" class="
                    Anchor-c11n-8-53-1__sc-hn4bge-0
                    pfs__j60ma-0
                    bMPPMx
                    znav-topnav-logo
                  "><img src="https://s.zillowstatic.com/pfs/static/z-logo-default.svg" type="image/svg+xml"
                                alt="Zillow logo" focusable="false" height="32" width="152"
                                class="pfs__j60ma-1 eCEnCc" /></a>
                    </li>
                    <li>
                        <div id="socialLinks" data-za-category="Homepage" data-za-action="Social Icon"
                            class="pfs__sc-1l86zl0-0 fXxFYE">
                            <span>Follow us:</span><a href="https://www.facebook.com/Zillow"
                                rel="nofollow noopener noreferrer" target="_blank"
                                class="Anchor-c11n-8-53-1__sc-hn4bge-0 pfs__chkjii-1 aIAqv" data-za-category="!inherit"
                                data-za-action="!inherit" data-za-label="Facebook"
                                aria-label="Visit us on Facebook"><span aria-hidden="true"
                                    class="pfs__tgmoyx-0 eeFcCq"><svg viewBox="0 0 32 32" aria-hidden="true"
                                        focusable="false" role="img" class="Icon-c11n-8-53-1__sc-13llmml-0 gadpZM">
                                    ...
                                    </svg></span><span class="VisuallyHidden-c11n-8-53-1__sc-t8tewe-0 hObLRM">Visit
                                    us on facebook</span></a><a href="https://www.instagram.com/zillow"
                                rel="nofollow noopener noreferrer" target="_blank"
                                class="Anchor-c11n-8-53-1__sc-hn4bge-0 pfs__chkjii-1 aIAqv" data-za-category="!inherit"
                                data-za-action="!inherit" data-za-label="Instagram"
                                aria-label="Visit us on Instagram"><span aria-hidden="true"
                                    class="pfs__tgmoyx-0 erdJTy"><svg viewBox="0 0 32 32" aria-hidden="true"
                                        focusable="false" role="img" class="Icon-c11n-8-53-1__sc-13llmml-0 gadpZM">
                                    ...
                                    us on instagram</span></a><a href="https://www.tiktok.com/@zillow"
                                rel="nofollow noopener noreferrer" target="_blank"
                                class="Anchor-c11n-8-53-1__sc-hn4bge-0 pfs__chkjii-1 aIAqv" data-za-category="!inherit"
                                data-za-action="!inherit" data-za-label="TikTok" aria-label="Visit us on TikTok"><span
                                    aria-hidden="true" class="pfs__tgmoyx-0 kxwUUz"><svg viewBox="0 0 32 32"
                                        aria-hidden="true" focusable="false" role="img"
                                        class="Icon-c11n-8-53-1__sc-13llmml-0 gadpZM">
                    ...
                    <li>
                        <a href="https://www.hud.gov/program_offices/fair_housing_equal_opp"
                            ...
                            </svg><span class="VisuallyHidden-c11n-8-53-1__sc-t8tewe-0 hObLRM">Equal Housing
                                Opportunity</span></a>
                    </li>
                </ul>
            </div>
            <div>
                <svg class="footer-image" viewBox="0 0 1200 160" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
                    focusable="false">
                    <style>
                    .cls-1 {
                        fill: #0c4499;
                    ...
                    <path class="cls-2"
                        d="M815 151h1a20 20 0 006-11c2-4 2-9-1-14-7-13-23-6-29 1a16 16 0 00-3 15 19 19 0 0014 12 17 17 0 0012-3z">
                    </path>
                    <path class="cls-1" d="M806 131h1v29h-1z"></path>
                    <path class="cls-3"
                        d="M508 149c-1-1-4-1-5 1a7 7 0 00-1 3c0-3-1-12-5-12-3 0-3 8-3 12-2-4-3-6-5-6-6 0 1 13 1 13h14l2-3a19 19 0 002-4 5 5 0 000-2 3 3 0 000-2z">
                    </path>
                    <path class="cls-4"
                        d="M256 142c2 0 4 5 5 11 0-5 2-9 3-10 6 0 3 9 3 9l-2 8h-8s-7-17-1-18zM835 142c2 0 4 5 5 11 0-5 2-9 3-10 6 0 3 9 3 9l-2 8h-8s-7-17-1-18zM688 138c1-6-3-33-15-29-3 2-7 8-8 11-5 9-7 27 2 34 5 3 12 2 16-2 4-3 5-8 5-14z">
                    </path>
                    <path class="cls-1" d="M674 126h1v34h-1z"></path>
                    <path class="cls-3"
                        d="M1141 143c0-4-3-7-3-10l-2-10c-2-2-3-3-6-3s-4 1-6 3l-1 10-4 10c-2 7 2 13 9 13h3a11 11 0 0011-13h-1z">
                    </path>
                    <path class="cls-1" d="M1130 133h1v27h-1zM199 54l-38 63h77l-39-63z"></path>
                    <path class="cls-1" d="M149 55h51v62h-51z"></path>
                    <path class="cls-4" d="M149 54l-38 63h77l-39-63z"></path>
                    <path class="cls-5" d="M149 61l-34 56h69l-35-56zM115 117h69v21h-69z"></path>
                    <path class="cls-5" d="M165 117h69v21h-69z"></path>
                    <path class="cls-6" d="M130 122h14v10h-14zM211 122h14v10h-14z"></path>
                    <path class="cls-4" d="M115 138h119v22H115z"></path>
                    <path class="cls-1" d="M146 138h55v22h-55z"></path>
                    <path class="cls-4" d="M178 101l-22 37h45l-23-37z"></path>
                    <path class="cls-4" d="M168 101h10v9h-10z"></path>
                    <path class="cls-1" d="M168 101l-22 37h45l-23-37z"></path>
                    <path class="cls-4" d="M168 110l-13 22h27l-14-22z"></path>
                    <path class="cls-6" d="M121 141h21v13h-21zM209 141h20v13h-20z"></path>
                    <path class="cls-1" d="M146 137h45v23h-45z"></path>
                    <path class="cls-4" d="M168 138a7 7 0 018 7v15h-15v-15a7 7 0 017-7z"></path>
                    <path class="cls-6" d="M144 89h11v17h-11z"></path>
                    <path class="cls-4" d="M858 9h93v151h-93z"></path>
                    <path class="cls-1" d="M951 9h23v151h-23z"></path>
                    <path class="cls-7"
                        d="M868 19h13v26h-13zM894 19h14v26h-14zM868 52h13v27h-13zM894 52h14v27h-14zM868 85h13v26h-13zM894 85h14v26h-14zM924 19h14v26h-14zM924 52h14v27h-14zM924 85h14v26h-14z">
                    </path>
                    <path class="cls-1" d="M883 144h32v16h-32z"></path>
                    <path class="cls-6" d="M904 127c6 0 11 6 11 13v4h-30v-17z"></path>
                    <path class="cls-7" d="M885 127a13 13 0 00-12 13v4h25v-4a13 13 0 00-13-13zM848 0h103v9H848z">
                    </path>
                    <path class="cls-8" d="M951 0h23v9h-23z"></path>
                    <path class="cls-4" d="M1014 87h59v73h-59z"></path>
                    <path class="cls-1" d="M1073 87h27v73h-27z"></path>
                    <path class="cls-4" d="M1082 118h32v42h-32z"></path>
                    <path class="cls-1" d="M1114 118h12v42h-12z"></path>
                    <path class="cls-9" d="M1024 98h40v17h-40z"></path>
                    <path class="cls-6" d="M1032 98h24v17h-24zM1096 130h18v23h-18z"></path>
                    <path class="cls-9" d="M1114 130h8v23h-8z"></path>
                    <path class="cls-6" d="M1024 137h13v17h-13z"></path>
                    <path class="cls-9" d="M1024 154h13v6h-13z"></path>
                    <path class="cls-1" d="M1045 133h19v27h-19z"></path>
                    <path class="cls-9" d="M1049 137h15v23h-15zM1010 123h50v4h-50zM1010 85h63v3h-63z"></path>
                    <path class="cls-4" d="M1073 85h29v3h-29z"></path>
                    <path class="cls-1" d="M1059 123h7v4h-7z"></path>
                    <path class="cls-4"
                        d="M1083 113h1v5h-1zM1087 113h1v5h-1zM1090 113h1v5h-1zM1093 113h1v5h-1zM1096 113h1v5h-1zM1099 113h1v5h-1zM1102 113h1v5h-1zM1106 113h1v5h-1zM1109 113h1v5h-1zM1112 113h1v5h-1z">
                    </path>
                    <path class="cls-1" d="M1115 113h1v5h-1zM1119 113h1v5h-1zM1122 113h1v5h-1z"></path>
                    <path class="cls-9" d="M1082 111h32v2h-32z"></path>
                    <path class="cls-4" d="M1114 111h12v2h-12z"></path>
                    <path class="cls-9" d="M686 123h98v33h-98z"></path>
                    <path class="cls-4" d="M797 123H686l3-41h105l3 41z"></path>
                    <path class="cls-9" d="M736 85l24 28h-48l24-28z"></path>
                    <path class="cls-6" d="M763 115h-54l27-33zm-47-3h40l-20-25z"></path>
                    <path class="cls-6" d="M733 96h7v10h-7zM702 128h20v19h-20zM763 133h16v14h-16z"></path>
                    <path class="cls-4" d="M741 134h11v22h-11z"></path>
                    <path class="cls-10" d="M767 76h12v22h-12z"></path>
                    <path class="cls-11" d="M711 126h2v23h-2z"></path>
                    <path class="cls-11" d="M701 138v-2h23v2z"></path>
                    <path class="cls-6" d="M736 120h50v4h-50z"></path>
                    <path class="cls-6" d="M737 121v35h-3v-35zM758 120v36h-3v-36zM786 121v35h-3v-35z"></path>
                    <path class="cls-9" d="M713 93l24 28h-48l24-28z"></path>
                    <path class="cls-6" d="M740 123h-55l28-33zm-47-3h40l-20-24z"></path>
                    <path class="cls-6" d="M709 104h8v12h-8z"></path>
                    <path class="cls-10" d="M786 120h11v36h-11z"></path>
                    <path class="cls-4" d="M788 134h6v12h-6z"></path>
                    <path class="cls-10" d="M686 156h111v4H686z"></path>
                    <path class="cls-4" d="M505 72h103v88H505z"></path>
                    <path class="cls-1"
                        d="M505 146h103v1H505zM505 140h103v1H505zM505 134h103-103zM505 127h103v1H505zM505 121h103v1H505zM505 115h103v1H505zM505 109h103-103zM505 102h103v1H505zM505 96h103v1H505zM505 90h103v1H505zM505 83h103v1H505zM505 77h103v1H505zM616 106h23v54h-23z">
                    </path>
                    <path class="cls-1" d="M505 72h38v37h-38z"></path>
                    <path class="cls-5" d="M497 103h46v7h-46z"></path>
                    <path class="cls-1" d="M526 127h17v29h-17z"></path>
                    <path class="cls-5"
                        d="M547 130h8v7h-8zM560 130h8v7h-8zM583 86h7v8h-7zM596 86h8v8h-8zM522 126h21v4h-21z"></path>
                    <path class="cls-4"
                        d="M616 154h23v1h-23zM616 148h23v1h-23zM616 141h23v1h-23zM616 135h23v1h-23zM616 129h23v1h-23zM616 123h23-23zM616 116h23v1h-23zM578 106h38v54h-38z">
                    </path>
                    <path class="cls-1"
                        d="M578 154h38v1h-38zM578 148h38v1h-38zM578 141h38v1h-38zM578 135h38v1h-38zM578 129h38v1h-38zM578 123h38-38zM578 116h38v1h-38z">
                    </path>
                    <path class="cls-4" d="M505 98h38v1h-38zM505 92h38-38zM505 85h38v1h-38zM505 79h38v1h-38z">
                    </path>
                    <path class="cls-5" d="M574 105h45v7h-45z"></path>
                    <path class="cls-1" d="M617 105h28v7h-28z"></path>
                    <path class="cls-5" d="M497 156h81v4h-81z"></path>
                    <path class="cls-4" d="M387 0h43v24h-43z"></path>
                    <path class="cls-9" d="M304 0h83v24h-83z"></path>
                    <path class="cls-4" d="M295 16h95v144h-95z"></path>
                    <path class="cls-1" d="M387 16h54v144h-54zM295 52h92v4h-92zM295 85h92v4h-92zM295 119h92v4h-92z">
                    </path>
                    <path class="cls-9" d="M299 23h84v28h-84zM299 58h84v25h-84zM299 91h84v25h-84zM300 125h82v35h-82z">
                    </path>
                    <path class="cls-4"
                        d="M355 18h3v33h-3zM323 18h4v33h-4zM355 57h3v27h-3zM323 56h4v28h-4zM355 90h3v27h-3zM323 90h4v27h-4zM392 91h44v25h-44zM392 58h44v25h-44zM392 23h45v28h-45z">
                    </path>
                    <path class="cls-6" d="M326 160v-20h30v20"></path>
                    <path class="cls-4" d="M358 160h-4v-19h-27v19h-3v-22h34v22z"></path>
                    <path class="cls-1"
                        d="M477 143c-5-3-10 7-10 7s7-15 1-16c-3 0-5 6-7 13 0-6-1-11-3-11-6-1-3 15-3 15l2 9h10s14-14 10-17z">
                    </path>
                    <path class="cls-3"
                        d="M1004 149c-1-1-4-1-5 1a7 7 0 00-1 3c0-3-1-12-5-12-3 0-3 8-3 12-1-4-3-6-5-6-6 0 1 13 1 13h14l2-3a19 19 0 002-4 5 5 0 000-2 3 3 0 000-2z">
                    </path>
                    <path class="cls-1"
                        d="M1154 145h1a28 28 0 0013 2c6 0 11-2 15-5 11-11-3-22-13-24-6-2-13-1-18 2s-8 9-6 15a15 15 0 008 10z">
                    </path>
                    <path class="cls-1"
                        d="M1157 122l1 1a19 19 0 0010 1c4 0 8-1 10-4 8-9-2-18-9-20a14 14 0 00-13 2 13 13 0 00-5 12 13 13 0 006 8z">
                    </path>
                    <path class="cls-1" d="M1165 123h1v37h-1z"></path>
                    <path class="cls-4"
                        d="M66 137c-1-6-5-11-6-17-2-5-1-11-3-16a14 14 0 00-25 0c-3 5-2 11-3 16l-7 17a23 23 0 008 23h28a23 23 0 008-23z">
                    </path>
                    <path class="cls-1" d="M45 113h1v47h-1z"></path>
                    <path class="cls-3"
                        d="M303 149c-1-1-4-1-5 1a7 7 0 00-1 3c0-3-1-12-5-12-3 0-3 8-3 12-2-4-3-6-5-6-6 0 1 13 1 13h14l2-3a19 19 0 002-4 5 5 0 000-2 3 3 0 000-2zM84 143c-2-3-5-2-7 0a13 13 0 00-2 6c0-6 0-20-6-20-5 0-5 14-5 20-1-7-4-10-7-10-8 1 2 21 2 21h20l3-5a34 34 0 002-6 10 10 0 000-4 6 6 0 000-2z">
                    </path>
                </svg>
            </div>
        </footer>
                    ...
                    <div class="pt-4 tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="signin" role="tabpanel" aria-labelledby="signin-tab">
                            ...
                            <form id="form_sign_in" onsubmit="return false">
                                ...
                                <input name="user_email" type="email" data="str" placeholder="Enter email" data-min="2"
                                    data-max="50">

                                <label for="user_password">Password</label>
                                <input name="user_password" type="password" data="str" placeholder="Enter Password"
                        ...
                        <div class="tab-pane fade" id="signup" role="tabpanel" aria-labelledby="signup-tab">
                            ...
                            <form id="form_sign_up" onsubmit="return false">
                                <label for="user_email">Email</label>
                                <input name="user_email" type="email" data="str" placeholder="Enter email" data-min="5"
                                    data-max="30">

                                <label for="user_password">Password</label>
                                <input name="user_password" type="password" data="str" placeholder="Create password"
