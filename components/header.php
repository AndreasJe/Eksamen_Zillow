...
<body>
    <header class="dark">
        ...
        <a class="mobile-signin" href="#signin">Sign In</a>
        <?php else :  ?>
        <li class="user-nav2">
            <div class="dropdown2">
                <button onclick="userNav2()" class="dropbtn2"><img src=" ../img/permanent/user.png"
                        alt="Default user icon"></button>
                <div id="myDropdown2" class="dropdown-content2">
                    ...
                    <a href="products"><span class="Text-c11n-8-53-1__sc-aiai24-0 pfs__sc-16r5mxa-0 cDxHF"><span>Saved
                                Homes</span></span></a>
                    <a style="border-top:1px solid black" href="logout">Sign out</a>
                </div>
            </div>
        </li>
        <?php endif; ?>
        ...
        <nav role="navigation">
            ...
            <ul class="main-nav">
                ...
                <li class="user-nav top-level-link">
                    <div class="dropdown">
                        <button onclick="userNav1()" class="dropbtn"><img class="dropbtn2"
